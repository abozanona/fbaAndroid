...
final class FragmentState implements Parcelable {
    public static final Creator CREATOR = new C0024u();
    final String f62a;
    final int f63b;
    final boolean f64c;
    final int f65d;
    ...
    public Fragment m73a(C0012h c0012h, Fragment fragment) {
        if (this.f72k != null) {
            return this.f72k;
        }
        if (this.f70i != null) {
            this.f70i.setClassLoader(c0012h.getClassLoader());
        }
        this.f72k = Fragment.m12a((Context) c0012h, this.f62a, this.f70i);
        if (this.f71j != null) {
            this.f71j.setClassLoader(c0012h.getClassLoader());
