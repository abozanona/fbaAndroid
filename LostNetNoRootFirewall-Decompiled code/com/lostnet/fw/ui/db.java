...
abstract class db extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view2 == null) {
            view2 = (RelativeLayout) LayoutInflater.from(context).inflate(C0329l.list_view_item_log, viewGroup, false);
            view2.setTag(cxVar);
        }
        View view3 = view2;
        ...
        TextView textView2 = (TextView) view3.findViewById(C0328k.itemComment);
        long j = cxVar.f1748a.f1751a % 24;
        ((TextView) view3.findViewById(C0328k.itemWhen)).setText(String.format("%02d:%02d\n-\n%02d:%02d", new Object[]{Long.valueOf(j), Integer.valueOf(0), Long.valueOf(j), Integer.valueOf(59)}));
        ...
        if (mo764c()) {
            textView2.setText(resources.getString(C0330m.logs_blocked_1) + " " + cxVar.f1749b.f1754a + " " + resources.getString(C0330m.logs_blocked_2) + " " + cxVar.f1749b.f1755b.size() + " " + resources.getString(C0330m.logs_blocked_3));
        } else {
