...
public class DetailsAppActivity extends Activity {
    ...
    public void m2039a(Context context) {
        ...
        XYPlot xYPlot = (XYPlot) findViewById(C0328k.detailsGraphHours);
        XYPlot xYPlot2 = (XYPlot) findViewById(C0328k.detailsGraphDays);
        XYPlot xYPlot3 = (XYPlot) findViewById(C0328k.detailsGraphMonth);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0329l.activity_details_app);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setHomeButtonEnabled(true);
        Integer valueOf = Integer.valueOf(getIntent().getIntExtra("id", 0));
        this.f1453a = valueOf;
        Boolean bool = ("com.lostnet.fw.free".equals(getResources().getString(C0330m.package_name)) || !C0313j.m2004a((Context) this)) ? Boolean.FALSE : Boolean.TRUE;
        ((TextView) findViewById(C0328k.detailsName)).setText(C0308e.m1964a(valueOf.intValue()));
        this.f1457e = (TextView) findViewById(C0328k.detailsUpload);
        this.f1458f = (TextView) findViewById(C0328k.detailsDownload);
        TextView textView = (TextView) findViewById(C0328k.detailsTextBlock);
        this.f1465m = (CheckBox) findViewById(C0328k.detailsBackground);
        this.f1466n = (CheckBox) findViewById(C0328k.detailsNight);
        this.f1467o = (CheckBox) findViewById(C0328k.detailsOffice);
        if (!bool.booleanValue()) {
            textView.setText(C0330m.checkboxCommentFree);
            this.f1466n.setEnabled(false);
            this.f1467o.setEnabled(false);
        }
        RadioButton radioButton = (RadioButton) findViewById(C0328k.buttonAllow);
        RadioButton radioButton2 = (RadioButton) findViewById(C0328k.buttonWiFiOnly);
        RadioButton radioButton3 = (RadioButton) findViewById(C0328k.buttonBlock);
        FirewallManagerService a = FirewallManagerService.m1852a(null);
        if (a != null) {
            C0289a c0289a;
        ...
        ImageView imageView = (ImageView) findViewById(C0328k.detailsIcon);
        Bitmap b2 = C0308e.m1967b(valueOf.intValue());
        if (b2 != null) {
            imageView.setImageBitmap(b2);
        }
        ViewPager viewPager = (ViewPager) findViewById(C0328k.detailsGraphPager);
        viewPager.setAdapter(new C0351p(this));
        TabHost tabHost = (TabHost) findViewById(C0328k.detailsTabHost);
        tabHost.setup();
        TabSpec newTabSpec = tabHost.newTabSpec("one");
        newTabSpec.setContent(C0328k.detailsGraphPager);
        newTabSpec.setIndicator(getResources().getString(C0330m.title_tab_1day));
        tabHost.addTab(newTabSpec);
        newTabSpec = tabHost.newTabSpec("seven");
        newTabSpec.setContent(C0328k.detailsGraphPager);
        newTabSpec.setIndicator(getResources().getString(C0330m.title_tab_7days));
        tabHost.addTab(newTabSpec);
        ...
        if ("com.lostnet.fw.free".equals(getResources().getString(C0330m.package_name)) || !C0313j.m2004a((Context) this)) {
            newTabSpec.setIndicator(getResources().getString(C0330m.title_tab_30days));
        } else {
            newTabSpec.setIndicator(getResources().getString(C0330m.title_tab_30days_pro));
        }
        tabHost.addTab(newTabSpec);
        ...
        this.f1454b = (ListView) findViewById(C0328k.detailsListHourly);
        this.f1455c = (ListView) findViewById(C0328k.detailsListDaily);
        this.f1456d = (ListView) findViewById(C0328k.detailsListMonth);
        m2039a(this);
        this.f1457e.setText(C0312i.m2001a(getApplicationContext(), this.f1459g));
        this.f1458f.setText(C0312i.m2001a(getApplicationContext(), this.f1460h));
    }
