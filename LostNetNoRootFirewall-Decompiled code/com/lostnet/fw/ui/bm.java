...
class bm extends NumberFormat {
    ...
    public StringBuffer format(double d, StringBuffer stringBuffer, FieldPosition fieldPosition) {
        ...
        int i2 = (int) d;
        char c2 = this.f1680a.getResources().getString(C0330m.data_byte).toCharArray()[0];
        char c3;
        if (i2 < 1000) {
            c3 = c2;
            i = i2;
            ...
            if (i2 < 1000) {
                i = i2;
                c = this.f1680a.getResources().getString(C0330m.data_kilobyte).toCharArray()[0];
            } else {
                i2 /= 1024;
                if (i2 < 1000) {
                    i = i2;
                    c = this.f1680a.getResources().getString(C0330m.data_megabyte).toCharArray()[0];
                } else {
                    c3 = c2;
                    i = i2;
                    c = c3;
