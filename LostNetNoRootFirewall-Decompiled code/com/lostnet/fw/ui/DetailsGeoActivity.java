...
public class DetailsGeoActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0329l.activity_details_geo);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setHomeButtonEnabled(true);
        String stringExtra = getIntent().getStringExtra("name");
        this.f1468a = getIntent().getStringArrayListExtra("codes");
        if (this.f1468a.size() == 1) {
            getActionBar().setTitle(C0330m.title_activity_details_country);
        } else {
            getActionBar().setTitle(C0330m.title_activity_details_region);
        }
        ((TextView) findViewById(C0328k.detailsName)).setText(stringExtra);
        this.f1472e = (TextView) findViewById(C0328k.detailsUpload);
        this.f1473f = (TextView) findViewById(C0328k.detailsDownload);
        ((RadioButton) findViewById(C0328k.buttonWiFiOnly)).setVisibility(8);
        RadioButton radioButton = (RadioButton) findViewById(C0328k.buttonAllow);
        RadioButton radioButton2 = (RadioButton) findViewById(C0328k.buttonBlock);
        FirewallManagerService a = FirewallManagerService.m1852a(null);
        if (a != null) {
            int i;
        ...
        this.f1470c = (ListView) findViewById(C0328k.detailsListHourly);
        this.f1469b = (ListView) findViewById(C0328k.detailsListDaily);
        this.f1471d = (ListView) findViewById(C0328k.detailsListMonth);
        m2041a(this);
