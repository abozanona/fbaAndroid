...
import com.lostnet.fw.p009d.C0304a;
...
public class DashboardActivity extends C0012h implements TabListener {
    C0337c f1447n;
    ao f1448o;
    ad f1449p;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(C0329l.activity_dashboard);
        ...
        this.f1451r = (DashboardViewPager) findViewById(C0328k.pager);
    ...
    public void onStart() {
        ...
        if (C0310g.m1987a(this)) {
            ...
            create.setTitle(getResources().getString(C0330m.popup_vpn_title));
            create.setMessage(getResources().getString(C0330m.popup_vpn_content));
            create.setButton(-1, getResources().getString(C0330m.button_ok), new bd(this));
            create.show();
        } else {
            this.f1448o.m2057c(this);
        }
    ...
    public void onTabSelected(Tab tab, FragmentTransaction fragmentTransaction) {
        ...
        if (tag == this.f1449p && C0310g.m1993e()) {
            ...
            builder.setTitle(C0330m.popup_click_apps_title);
            View inflate = layoutInflater.inflate(C0329l.dialog_warn_dont, null);
            ((TextView) inflate.findViewById(C0328k.dialogText)).setText(C0330m.popup_click_apps_content);
            CheckBox checkBox = (CheckBox) inflate.findViewById(C0328k.dialogCheckbox);
            checkBox.setText(C0330m.popup_click_apps_checkbox);
            checkBox.setOnCheckedChangeListener(new bj(this, arrayList));
            builder.setView(inflate);
            builder.setPositiveButton(C0330m.button_ok, new C0336b(this, arrayList));
            builder.create().show();
        }
    }
