...
import com.lostnet.fw.p004a.C0276a;
...
class aw extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = c0276a.m1886a() == C0284b.COUNTRY ? (RelativeLayout) from.inflate(C0329l.list_view_item_suggestion_geo, viewGroup, false) : (RelativeLayout) from.inflate(C0329l.list_view_item_suggestion_app, viewGroup, false);
        }
        ImageView imageView = (ImageView) view.findViewById(C0328k.suggestionIcon);
        TextView textView = (TextView) view.findViewById(C0328k.suggestionName);
        TextView textView2 = (TextView) view.findViewById(C0328k.suggestionComment);
        ((ImageView) view.findViewById(C0328k.buttonCancel)).setOnClickListener(new ax(this, a, b, context));
        String a2;
        ...
        if (c0276a.m1886a() == C0284b.COUNTRY) {
            ...
            radioButton = (RadioButton) view.findViewById(C0328k.buttonAllow);
            radioButton2 = (RadioButton) view.findViewById(C0328k.buttonBlock);
            ...
            radioButton = (RadioButton) view.findViewById(C0328k.buttonAllow);
            radioButton2 = (RadioButton) view.findViewById(C0328k.buttonWiFiOnly);
            RadioButton radioButton3 = (RadioButton) view.findViewById(C0328k.buttonBlock);
            a3 = FirewallManagerService.m1852a(null);
            if (a3 != null) {
                C0289a c0289a;
