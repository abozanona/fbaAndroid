...
public class SectionGeoListFragment extends cd {
    ...
    public View mo749a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        RelativeLayout relativeLayout = (RelativeLayout) layoutInflater.inflate(C0329l.activity_list_geo, viewGroup, false);
        ViewPager viewPager = (ViewPager) relativeLayout.findViewById(C0328k.geoPager);
        viewPager.setAdapter(new en());
        ((DashboardViewPager) m30b().findViewById(C0328k.pager)).setChildId(C0328k.geoPager);
        TabHost tabHost = (TabHost) relativeLayout.findViewById(C0328k.geoTabHost);
        tabHost.setup();
        TabSpec newTabSpec = tabHost.newTabSpec("map");
        newTabSpec.setContent(C0328k.geoPager);
        newTabSpec.setIndicator(m37c().getString(C0330m.title_section3_map));
        tabHost.addTab(newTabSpec);
        newTabSpec = tabHost.newTabSpec("list");
        newTabSpec.setContent(C0328k.geoPager);
        newTabSpec.setIndicator(m37c().getString(C0330m.title_section3_list));
        tabHost.addTab(newTabSpec);
        ...
        this.f1511U = (WebView) relativeLayout.findViewById(C0328k.webViewCountries);
        RelativeLayout relativeLayout2 = (RelativeLayout) relativeLayout.findViewById(C0328k.mapEntriesHolder);
        Spinner spinner = (Spinner) relativeLayout.findViewById(C0328k.mapType);
        ...
        this.f1509S = (Button) relativeLayout.findViewById(C0328k.buttonShare);
        this.f1509S.setOnClickListener(new dz(this));
        this.f1510T = (TextView) relativeLayout.findViewById(C0328k.listPro);
        this.R = (ListView) relativeLayout.findViewById(C0328k.listItems);
        ...
        Spinner spinner2 = (Spinner) relativeLayout.findViewById(C0328k.listSpinnerCnts);
        SpinnerAdapter createFromResource = ArrayAdapter.createFromResource(context, C0326i.spinner_cnts, C0329l.multiline_spinner_dropdown_item);
        createFromResource.setDropDownViewResource(17367049);
        spinner2.setAdapter(createFromResource);
        spinner2.setOnItemSelectedListener(new ea(this));
        spinner2 = (Spinner) relativeLayout.findViewById(C0328k.listSpinnerPeriod);
        createFromResource = ("com.lostnet.fw.free".equals(m37c().getString(C0330m.package_name)) || !C0313j.m2004a(context)) ? ArrayAdapter.createFromResource(context, C0326i.spinner_period, C0329l.multiline_spinner_dropdown_item) : ArrayAdapter.createFromResource(context, C0326i.spinner_period_pro, C0329l.multiline_spinner_dropdown_item);
        createFromResource.setDropDownViewResource(17367049);
        spinner2.setAdapter(createFromResource);
    ...
    public synchronized void mo751a(ListAdapter listAdapter) {
        if (this.f1508Q == bn.THIRTY_DAYS && (this.R == null || "com.lostnet.fw.free".equals(m37c().getString(C0330m.package_name)) || !C0313j.m2004a(this.R.getContext()))) {
            if (this.R != null) {
    ...
    public android.widget.ListAdapter m2064d(android.content.Context r11) {
        ...
        r0.<init>();
        r0 = 0;
        r5 = com.lostnet.fw.FirewallManagerService.m1852a(r0);
        if (r5 == 0) goto L_0x0222;
    L_0x0011:
        monitor-enter(r10);
        r4.clear();	 Catch:{ all -> 0x00dd }
        r0 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00dd }
    ...
    L_0x0022:
        ...
        r0 = com.lostnet.fw.ui.dx.f1789b;	 Catch:{ all -> 0x00dd }
    ...
    L_0x0041:
        ...
        r0 = (com.lostnet.fw.p008c.C0297b) r0;	 Catch:{ all -> 0x00da }
    ...
    L_0x0055:
        ...
        r2 = (com.lostnet.fw.p007b.C0292d) r2;	 Catch:{ all -> 0x00da }
        r7 = r1.intValue();	 Catch:{ all -> 0x00da }
        r7 = com.lostnet.fw.p009d.C0309f.m1974a(r7);	 Catch:{ all -> 0x00da }
        r7 = com.lostnet.fw.p009d.C0309f.m1975a(r7);	 Catch:{ all -> 0x00da }
        r8 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00da }
    ...
    L_0x007c:
        ...
        r1 = (com.lostnet.fw.p008c.C0298c) r1;	 Catch:{ all -> 0x00da }
        if (r1 != 0) goto L_0x00b3;
    L_0x008c:
        r1 = r10.f1507P;	 Catch:{ all -> 0x00da }
        r8 = com.lostnet.fw.ui.bi.REGION_SEEN;	 Catch:{ all -> 0x00da }
    ...
    L_0x00ae:
        r1 = new com.lostnet.fw.c.g;	 Catch:{ all -> 0x00da }
    ...
    L_0x00dd:
        ...
        throw r0;
    L_0x00e0:
        r0 = com.lostnet.fw.p009d.C0309f.m1976a();	 Catch:{ all -> 0x00dd }
    ...
    L_0x00ee:
        ...
        r2 = new com.lostnet.fw.c.g;	 Catch:{ all -> 0x00dd }
        r2.<init>();	 Catch:{ all -> 0x00dd }
        r4.put(r0, r2);	 Catch:{ all -> 0x00dd }
        goto L_0x00e8;
    L_0x00fd:
        r2 = com.lostnet.fw.p008c.C0296a.m1929b();	 Catch:{ all -> 0x00dd }
    ...
    L_0x011b:
        ...
        throw r0;	 Catch:{ all -> 0x00dd }
    L_0x011e:
        r2 = com.lostnet.fw.p008c.C0296a.m1928a();	 Catch:{ all -> 0x00dd }
    ...
    L_0x013f:
        ...
        r7 = com.lostnet.fw.C0330m.package_name;	 Catch:{ all -> 0x00dd }
        r1 = r1.getString(r7);	 Catch:{ all -> 0x00dd }
        r0 = r0.equals(r1);	 Catch:{ all -> 0x00dd }
        if (r0 != 0) goto L_0x0034;
    L_0x0155:
        r0 = com.lostnet.fw.p009d.C0313j.m2004a(r11);	 Catch:{ all -> 0x00dd }
        if (r0 == 0) goto L_0x0034;
    L_0x015b:
        r7 = r5.f1296e;	 Catch:{ all -> 0x00dd }
        monitor-enter(r7);	 Catch:{ all -> 0x00dd }
    ...
    L_0x0189:
        ...
        r1 = r10.f1507P;	 Catch:{ all -> 0x00dd }
        r2 = com.lostnet.fw.ui.bi.REGION_ALLOWED;	 Catch:{ all -> 0x00dd }
        if (r1 == r2) goto L_0x019f;
    L_0x0199:
        r1 = r10.f1507P;	 Catch:{ all -> 0x00dd }
        r2 = com.lostnet.fw.ui.bi.REGION_BLOCKED;	 Catch:{ all -> 0x00dd }
    ...
    L_0x01a9:
        ...
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00dd }
        r2 = 1;
        r1 = com.lostnet.fw.p009d.C0309f.m1978b(r0);	 Catch:{ all -> 0x00dd }
    ...
    L_0x01be:
        ...
        r1 = com.lostnet.fw.p009d.C0309f.m1982d(r1);	 Catch:{ all -> 0x00dd }
        ...
        r1 = (com.lostnet.fw.p007b.C0292d) r1;	 Catch:{ all -> 0x00dd }
        r7 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00dd }
    ...
    public android.widget.ListAdapter m2065e(android.content.Context r15) {
        ...
        r3.<init>();
        r2 = com.lostnet.fw.FirewallManagerService.m1852a(r0);
        if (r2 == 0) goto L_0x01fa;
    L_0x0014:
        monitor-enter(r14);
        r4.clear();	 Catch:{ all -> 0x00dc }
        r0 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00dc }
    ...
    L_0x0025:
        ...
        r0 = com.lostnet.fw.ui.dx.f1789b;	 Catch:{ all -> 0x00dc }
    ...
    L_0x0044:
        ...
        r0 = (com.lostnet.fw.p008c.C0297b) r0;	 Catch:{ all -> 0x00d9 }
    ...
    L_0x0058:
        ...
        r2 = (com.lostnet.fw.p007b.C0292d) r2;	 Catch:{ all -> 0x00d9 }
        r8 = r1.intValue();	 Catch:{ all -> 0x00d9 }
        r8 = com.lostnet.fw.p009d.C0309f.m1974a(r8);	 Catch:{ all -> 0x00d9 }
        r9 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00d9 }
    ...
    L_0x007b:
        ...
        r1 = (com.lostnet.fw.p008c.C0298c) r1;	 Catch:{ all -> 0x00d9 }
        if (r1 != 0) goto L_0x00b2;
    L_0x008b:
        r1 = r14.f1507P;	 Catch:{ all -> 0x00d9 }
        r9 = com.lostnet.fw.ui.bi.COUNTRY_SEEN;	 Catch:{ all -> 0x00d9 }
    ...
    L_0x00ad:
        r1 = new com.lostnet.fw.c.g;	 Catch:{ all -> 0x00d9 }
    ...
    L_0x00dc:
        ...
        throw r0;
    L_0x00df:
        r0 = com.lostnet.fw.p009d.C0309f.m1979b();	 Catch:{ all -> 0x00dc }
    ...
    L_0x00ed:
        ...
        r5 = new com.lostnet.fw.c.g;	 Catch:{ all -> 0x00dc }
        r5.<init>();	 Catch:{ all -> 0x00dc }
        r4.put(r0, r5);	 Catch:{ all -> 0x00dc }
        goto L_0x00e7;
    L_0x00fc:
        r5 = com.lostnet.fw.p008c.C0296a.m1929b();	 Catch:{ all -> 0x00dc }
    ...
    L_0x0118:
        ...
        throw r0;	 Catch:{ all -> 0x00dc }
    L_0x011b:
        r5 = com.lostnet.fw.p008c.C0296a.m1928a();	 Catch:{ all -> 0x00dc }
    ...
    L_0x013a:
        ...
        r8 = com.lostnet.fw.C0330m.package_name;	 Catch:{ all -> 0x00dc }
        r1 = r1.getString(r8);	 Catch:{ all -> 0x00dc }
        r0 = r0.equals(r1);	 Catch:{ all -> 0x00dc }
        if (r0 != 0) goto L_0x0037;
    L_0x0150:
        r0 = com.lostnet.fw.p009d.C0313j.m2004a(r15);	 Catch:{ all -> 0x00dc }
        if (r0 == 0) goto L_0x0037;
    L_0x0156:
        r8 = r2.f1296e;	 Catch:{ all -> 0x00dc }
        monitor-enter(r8);	 Catch:{ all -> 0x00dc }
    ...
    L_0x0181:
        ...
        r1 = r14.f1507P;	 Catch:{ all -> 0x00dc }
        r2 = com.lostnet.fw.ui.bi.COUNTRY_ALLOWED;	 Catch:{ all -> 0x00dc }
        if (r1 == r2) goto L_0x0197;
    L_0x0191:
        r1 = r14.f1507P;	 Catch:{ all -> 0x00dc }
        r2 = com.lostnet.fw.ui.bi.COUNTRY_BLOCKED;	 Catch:{ all -> 0x00dc }
    ...
    L_0x01a1:
        ...
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x00dc }
        r1 = com.lostnet.fw.p009d.C0309f.m1982d(r0);	 Catch:{ all -> 0x00dc }
        ...
        r1 = (com.lostnet.fw.p007b.C0292d) r1;	 Catch:{ all -> 0x00dc }
        r6 = com.lostnet.fw.ui.dx.f1788a;	 Catch:{ all -> 0x00dc }
    ...
    L_0x01fa:
        ...
        r2 = "NO MANAGER !!!!";
        com.lostnet.fw.p009d.C0315l.m2018a(r1, r2);
        goto L_0x01f9;
        */
