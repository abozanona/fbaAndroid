...
class ep implements OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker timePicker, int i, int i2) {
        ...
        this.f1829c.f1826a.f1521h.setText(this.f1829c.f1826a.getResources().getText(R.string.night_from) + " " + str + " " + this.f1829c.f1826a.getResources().getText(R.string.night_till) + " " + (String.format("%02d", new Object[]{this.f1829c.f1826a.f1524k}) + ":" + String.format("%02d", new Object[]{this.f1829c.f1826a.f1525l})));
