...
public class C0320a {
    ...
    public C0320a(int i) {
        this.f1426a = i;
        this.f1432g.setColor(0xffff0000);
        ...
        this.f1433h.setColor(0xffff0000);
        ...
        this.f1434i.setColor(0xffff0000);
        ...
        this.f1435j.setColor(0xffff0000);
    ...
    private void m2033a() {
        ...
        if (this.f1427b == null || this.f1427b.size() < 1) {
            this.f1431f.drawText(resources.getString(R.string.widget_graph_blocked_none), 10.0f, 20.0f, this.f1432g);
            return;
        }
        int i2;
        int i3 = 0;
        ...
        String string = resources.getString(R.string.widget_graph_blocked_str1);
        String str = i3 + " " + resources.getString(R.string.widget_graph_blocked_str2);
        String str2 = this.f1426a + " " + resources.getString(R.string.widget_graph_blocked_str3);
