...
abstract class eg extends BaseAdapter {
    ...
    protected View m2133a(Drawable drawable, String str, C0298c c0298c, ArrayList arrayList, int i, View view, ViewGroup viewGroup, boolean z) {
        ...
        View view3 = view2;
        RadioButton radioButton = (RadioButton) view3.findViewById(R.id.buttonAllow);
        RadioButton radioButton2 = (RadioButton) view3.findViewById(R.id.buttonBlock);
        ImageView imageView = (ImageView) view3.findViewById(R.id.itemIcon);
        TextView textView3 = (TextView) view3.findViewById(R.id.itemName);
        if (c0298c != null) {
            textView = (TextView) view3.findViewById(R.id.itemUpload);
