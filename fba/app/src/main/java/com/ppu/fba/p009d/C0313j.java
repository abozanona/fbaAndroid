...
public class C0313j {
    ...
    public static boolean m2004a(Context context) {
        ...
        return packageManager.checkSignatures(context.getPackageName(), "com.ppu.fba.pro") == 0 || packageManager.checkSignatures(context.getPackageName(), "com.ppu.fba.test") == 0;
    }
