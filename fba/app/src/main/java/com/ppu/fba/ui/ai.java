...
public class ai extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view2 == null) {
            View view5 = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.list_view_item_app, viewGroup, false);
            view5.setTag(num);
            view5.setDrawingCacheBackgroundColor(-16777216);
            radioButton = (RadioButton) view5.findViewById(R.id.buttonAllow);
            radioButton2 = (RadioButton) view5.findViewById(R.id.buttonWiFiOnly);
            radioButton3 = (RadioButton) view5.findViewById(R.id.buttonBlock);
            ...
            radioButton3 = (RadioButton) view2.findViewById(R.id.buttonBlock);
            radioButton2 = (RadioButton) view2.findViewById(R.id.buttonWiFiOnly);
            view3 = view2;
        ...
        View findViewById = view3.findViewById(R.id.itemOffice);
        if ((c0289a.m1921b() & 32) != 0) {
            findViewById.setVisibility(0);
        }
        findViewById = view3.findViewById(R.id.itemNight);
        if ((c0289a.m1921b() & 16) != 0) {
            findViewById.setVisibility(0);
        }
        findViewById = view3.findViewById(R.id.itemBackground);
