...
import com.ppu.fba.p008c.C0300e;
import com.ppu.fba.p008c.C0301f;
...
public class FirewallManagerService extends Service implements Runnable {
    ...
    private void m1853a() {
        ...
        intent = new Intent();
        intent.setAction("com.ppu.fba.ui.StatusChange");
    ...
    private void m1859e() {
        ...
        synchronized (this.f1294c) {
            //todo abozanona
            for (Object c0289a : this.f1294c.f1366a.values()) {
                int a = ((C0289a)c0289a).m1919a();
                int b = ((C0289a)c0289a).m1921b();
                    ...
                    switch (a) {
                        case APKExpansionPolicy.MAIN_FILE_URL_INDEX /*0*/:
                            if ((b & 8) == 0) {
                                ...
                                NativeWrapper.jni_dicke(((C0289a)c0289a).f1363a, 2);
                                break;
                            }
                        case 1:
        ...
        synchronized (this.f1295d) {
            //todo abozanona
            for (Object c0292d : this.f1295d.f1370a.values()) {
                NativeWrapper.jni_dickh(((C0292d)c0292d).f1367a, ((C0292d)c0292d).f1369c);
            }
    ...
    L_0x001a:
        ...
        com.ppu.fba.p009d.C0311h.m1998a(r7);	 Catch:{ all -> 0x00eb }
        ...
        r0 = "com.ppu.fba.free";
        r3 = r7.getResources();
        r4 = com.ppu.fba.R.string.package_name;
        r3 = r3.getString(r4);
        r0 = r0.equals(r3);
        if (r0 != 0) goto L_0x00ee;
    L_0x003d:
        r0 = com.ppu.fba.p009d.C0313j.m2004a(r7);
        if (r0 == 0) goto L_0x00ee;
    L_0x0043:
        r0 = java.lang.Boolean.TRUE;
        r0 = r0.booleanValue();
    L_0x0049:
        com.ppu.fba.p009d.C0316m.m2020a();
        r3 = com.ppu.fba.FirewallApplication.m1851a();
    ...
    L_0x00ee:
        ...
        goto L_0x0049;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ppu.fba.FirewallManagerService.onStartCommand(android.content.Intent, int, int):int");
    }
    ...
    public void run() {
        ...
        r0 = r10.f1304o;
        r0.start();
        com.ppu.fba.NativeWrapper.jni_dicka(r10);
    L_0x001f:
        r0 = r10.f1300k;
    ...
    L_0x002b:
        ...
        r0 = (com.ppu.fba.C0288a) r0;	 Catch:{ all -> 0x00da }
    ...
    L_0x0042:
        r1 = com.ppu.fba.FirewallVpnService.m1864a();	 Catch:{ all -> 0x00dd }
        if (r1 == 0) goto L_0x00e6;
    L_0x0048:
    ...
    L_0x005f:
        r4 = com.ppu.fba.NativeWrapper.jni_dickq();	 Catch:{ all -> 0x00dd }
    ...
    L_0x00be:
        com.ppu.fba.NativeWrapper.jni_dicko();
    ...
    L_0x0137:
        ...
        r0 = (com.ppu.fba.C0288a) r0;	 Catch:{ InterruptedException -> 0x00e0 }
    ...
    L_0x0178:
        ...
        goto L_0x0128;
    L_0x0181:
        r3 = com.ppu.fba.p008c.C0296a.m1930c();	 Catch:{ InterruptedException -> 0x00e0 }
    ...
    L_0x01ac:
        r0 = new com.ppu.fba.a;	 Catch:{ InterruptedException -> 0x00e0 }
        r1 = 5;
    ...
    L_0x01c6:
        ...
        goto L_0x00b9;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ppu.fba.FirewallManagerService.run():void");
    }
