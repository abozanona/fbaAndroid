...
public class C0362a extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] iArr) {
        ...
        remoteViews.setImageViewBitmap(R.id.imageGraph, C0362a.m2154a());
        Intent intent = new Intent("android.intent.action.MAIN", null);
        intent.addCategory("android.intent.category.LAUNCHER");
        intent.setComponent(new ComponentName(resources.getString(R.string.package_name), "com.ppu.fba.ui.SplashScreen"));
        intent.setFlags(268435456);
        intent.putExtra("lf", "wgb");
        remoteViews.setOnClickPendingIntent(R.id.imageGraph, PendingIntent.getActivity(context, 0, intent, 0));
